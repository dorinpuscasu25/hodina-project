...
import { ArrowRight, Clock, Home, MapPin, Search, Star } from 'lucide-react';
...
export const HomePage = ({ onNavigate }: HomePageProps) => {
  ...
  useSeo({
    ...
    description:
      language === 'ro'
        ? 'Rezervă experiențe autentice, pensiuni locale și cazări din Moldova direct pe Hodina.'
        : language === 'ru'
        ...
        <div className="max-w-4xl px-4 text-center">
          ...
          <form onSubmit={handleSearch} className="mx-auto max-w-2xl">
            <div className="flex items-center gap-2 rounded-full bg-white p-2 shadow-lg">
              ...
              <button
                type="submit"
                className="rounded-full bg-[#002626] px-8 py-3 font-semibold text-white transition-colors hover:bg-[#003838]"
              >
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-gray-600">
            {language === 'ro'
              ? 'Vezi pensiuni și case gata pentru următoarea rezervare.'
              : language === 'ru'
